...
package kr.hs.namgong.jms.util;
...
public class ImageLoader {
    ...
    public DrawableRequestBuilder<String> beginImageLoadRound(String url,
        ...
        if (crop) {
            return mGlideModelRequest.load(url).listener(requestListener)
                    .transform(new kr.hs.namgong.jms.util.CircleTransform(mContext)).centerCrop();
        } else {
            return mGlideModelRequest.load(url).listener(requestListener)
                    .transform(new kr.hs.namgong.jms.util.CircleTransform(mContext));
        }
    }
